...
public:
  ...
  virtual std::any visitFormalParams(MiniCParser::FormalParamsContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitLogicOrExp(MiniCParser::LogicOrExpContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitPrimaryUnaryExp(MiniCParser::PrimaryUnaryExpContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitNegativeUnaryExp(MiniCParser::NegativeUnaryExpContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLogicalNotUnaryExp(MiniCParser::LogicalNotUnaryExpContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitFuncCallUnaryExp(MiniCParser::FuncCallUnaryExpContext *ctx) override {
    return visitChildren(ctx);
  }
